...
namespace Renamer.Classes.Configuration
{
    ...
    class Settings : IEnumerable
    {
        ...
        private void SetupDefaults() {
            ...
            defaultConfigFile[ConfigKeyConstants.DIACRITIC_STRATEGY_KEY] = Renamer.Classes.MediaFile.UmlautAction.Use.ToString();
            defaultConfigFile[ConfigKeyConstants.LETTER_CASE_STRATEGY_KEY] = Renamer.Classes.MediaFile.Case.Ignore.ToString();
