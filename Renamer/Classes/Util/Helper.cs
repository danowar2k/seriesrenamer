...
namespace Renamer.Classes.Util
{
    /// <summary>
    ...
    public class Helper
    {
        ...
        public static bool IsMovie(MediaFile ie) {
        ...
        {
			return Path.GetDirectoryName(System.Reflection.Assembly.GetExecutingAssembly().Location) + Path.DirectorySeparatorChar + "Renamer.log";
        }
